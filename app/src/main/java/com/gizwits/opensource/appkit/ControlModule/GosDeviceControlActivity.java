...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_orisine;
	...
	private void initView() {
		...
		sw_bool_orisine = (Switch) findViewById(R.id.sw_bool_orisine);
	}

	private void initEvent() {

		sw_bool_orisine.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_orisine:
			sendCommand(KEY_ORISINE, sw_bool_orisine.isChecked());
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_orisine.setChecked(orisine);
